                      ...
                      <div class="card-body pt-1">
                        <form action="" method="post">
                          ...
                          <div class="sc col-log-2" style="float:right">
                                <input type="submit" name="submit" value="Registrasi" class="btn btn-primary rounded py-1 px-1" >
                                <a href="login.php" class="btn btn-primary rounded py-1 px-1">Login</a>
                         </div>
                        </form>
                      </div>
                    </div>
