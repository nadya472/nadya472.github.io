<?php
  ...
  $username = query("SELECT * from users ORDER BY id ASC LIMIT $awalData, $jumlahDataPerHalaman");

  // jika tombol cari di klik
  if (isset($_POST["cari"])) {
    $username = cari5($_POST["keyword"]);
  }
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="users.php" aria-expanded="false" aria-controls="form-elements">
              <i class="icon-paper menu-icon"></i>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="" method="post">
                    <input type="text" name="keyword" size="30" autofocus placeholder="Cari User" autocomplete="off">
                  ...
                  <div class="col-log-2" style="float:right">
                        <a href="cetak5.php" target="blank">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <tr>
                          ...
                          <td><?=$row ['username'];?></td>
                          <td><?=$row ['password'];?></td>
                          <td><a href="hapus5.php?id=<?= $row["id"] ?>"onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a></td>
                      </tr>
                      <?php endforeach; ?>
                    </table>
                    <div class="col-lg-12 col-md-6 text-right">
                    <a href="registrasi.php">
                      <button type="submit" href="registrasi.php" class="btn btn-primary rounded py-3 px-3 mt-4 mx-20">Tambah User</button>
                    </a>
                    </div>
                    <!-- NAVIGASI -->
