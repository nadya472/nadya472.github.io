<?php
  ...
  $jumlahData = count(query("SELECT * FROM berobat"));
  ...
  $berobat= query("SELECT * from berobat 
                       ...
                       JOIN obat ON berobat.id_obat = obat.id_obat
                        ORDER BY id_berobat DESC LIMIT $awalData, $jumlahDataPerHalaman
                          
                          ");

  // jika tombol cari di klik
  if (isset($_POST["cari"])) {
    $berobat = cari4($_POST["keyword"]);
  }
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="col-log-2" style="float:right">
                        <a href="tambah4.php">
                          <button type="submit" class="btn btn-primary rounded py-3 px-3 mt-4 mx-20" style="float:right">Tambah Rekam Medis</button>
                        </a> 
                  </div>
                  <div class="col-log-2" style="float:left">
                        <a href="cetak4.php" target="blank">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered" >
                      ...
                      <tr>
                          ...
                          <td><a href="hapus4.php?id=<?= $row["id_berobat"] ?>"onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a></td>
                      </tr>
                      <?php endforeach; ?>
                    </table>
                    <!-- NAVIGASI -->
