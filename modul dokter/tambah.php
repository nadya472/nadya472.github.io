<?php
  ...
  $nama_dokter = query("SELECT * from dokter");
  if (isset($_POST['submit'])) {
    if (tambah($_POST) > 0) {
      // pesan jika data tersimpan
      echo "<script>alert('Data Dokter berhasil ditambahkan'); 
      window.location.href='dokter.php'</script>";
      } else {
      // pesan jika data gagal disimpan
      echo "<script>alert('Data dokter gagal ditambahkan');
        window.location.href='dokter.php'</script>";
      } 
  }
?>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="">
                    <div class="form-group row col-12">
                      <label for="nama_dokter" class="col-md-4 col-form-label">Nama Dokter</label>
                      <div class="col-md-8">
