<?php
  ...
  $obat= query("SELECT * from obat ORDER BY id_obat ASC LIMIT $awalData, $jumlahDataPerHalaman");

  // jika tombol cari di klik
  if (isset($_POST["cari"])) {
    $obat = cari3($_POST["keyword"]);
  }
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="obat.php" aria-expanded="false" aria-controls="form-elements">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="" method="post">
                    <input type="text" name="keyword" size="30" autofocus placeholder="Cari Obat" autocomplete="off">
                    <button type="submit" class="btn btn-primary rounded py-2 px-3 mt-0.5 mx-2" name="cari">Cari</button>
                  </form>
                  <div class="col-log-2" style="float:right">
                        <a href="cetak3.php" target="blank">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <tr>
                          ...
                          <td><?=$row ['id_obat'];?></td>
                          <td><?=$row ['nama_obat'];?></td>
                          <td><a href="edit3.php?id=<?= $row["id_obat"] ?>">Ubah</a></td>
                          <td><a href="hapus3.php?id=<?= $row["id_obat"] ?>"onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a></td>
                      </tr>
                      <?php endforeach; ?>
                    </table>
                    <div class="col-lg-12 col-md-6 text-right">
                    <a href="tambah3.php">
                      <button type="submit"  class="btn btn-primary rounded py-3 px-3 mt-4 mx-20">Tambah Obat</button>
                    </a>
                    </div>
                    <!-- NAVIGASI -->
