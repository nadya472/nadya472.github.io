<?php
  ...
  if (isset($_POST['submit'])) {
    if (tambah3($_POST) > 0) {
      ...
      echo "<script>alert('Data Obat berhasil ditambahkan'); 
      window.location.href='obat.php'</script>";
      } else {
      // pesan jika data gagal disimpan
      echo "<script>alert('Data Obat gagal ditambahkan');
        window.location.href='obat.php'</script>";
      } 
  }
?>
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" action="">
                                    <div class="form-group row col-12">
                                        <label for="nama_dokter" class="col-md-4 col-form-label">Nama Obat</label>
                                        <div class="col-md-8">
