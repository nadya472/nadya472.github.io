<?php
  ...
  $nama_pasien = query("SELECT * from pasien where id_pasien = $id")[0];
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="">
                    <div class="form-group row col-12">
                      <div class="col-md-8">
                        <input type="hidden" class="form-control" name="id_pasien" value="<?=$nama_pasien["id_pasien"];?>">
                      </div>
                    </div>
                    <div class="form-group row col-12">
                      <label for="nama_pasien" class="col-md-4 col-form-label" autocomplete="off">Nama Pasien</label>
                      <div class="col-md-8">
                        <input type="text" class="form-control" name="nama_pasien" value="<?=$nama_pasien["nama_pasien"];?>">
                      </div>
                    </div>
                    <div class="form-group row col-12">
                      ...
                      <div class="col-md-8">
                        <select class="form-control" name="jenis_kelamin">
                            <option value="<?=$nama_pasien["jenis_kelamin"];?>"><?=$nama_pasien["jenis_kelamin"];?></option>
                    ...
                    <div class="form-group row col-12">
                      ...
                      <div class="col-md-8">
                        <input type="text" class="form-control" name="umur" value="<?=$nama_pasien["umur"];?>">
                      </div>
                    </div>
