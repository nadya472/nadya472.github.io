<?php
  ...
  $pasien = query("SELECT * from pasien ORDER BY id_pasien ASC LIMIT $awalData, $jumlahDataPerHalaman");
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="" method="post">
                    <input type="text" name="keyword" size="30" autofocus placeholder="Cari Pasien" autocomplete="off">
                  ...
                  <div class="col-log-2" style="float:right">
                        <a href="cetak2.php" target="blank">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <tr>
                          ...
                          <td><?=$row ['umur'];?></td>
                          <td><a href="edit2.php?id=<?= $row["id_pasien"] ?>">Ubah</a></td>
                          <td><a href="hapus2.php?id=<?= $row["id_pasien"] ?>"onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a></td>
                      </tr>
                      <?php endforeach; ?>
                    </table>
                    <div class="col-lg-12 col-md-6 text-right">
                    <a href="tambah2.php">
                      <button type="submit" class="btn btn-primary rounded py-3 px-3 mt-4 mx-20">Tambah Pasien</button>
                    </a>
                    </div>
                    <!-- NAVIGASI -->
